...
$$
  T^2={4\pi^2\over g}L,
$$
e portanto a dep\^endencia \'e linear. Em conformidade, a teoria prev\^e esta dep\^endencia. Para o gr\'afico {\it vide} \'ultima p\'agina.
...
$$
 ...
 \right],
$$
consequentemente a forma quadr\'atica Hessiana $H$ de $\nabla_{\chi^2}$ \'e
$$
  \eqalign{
    H(A,B)\cdot(a,b)&={2n\over\sigma_y^2}a^2+2{2S_x\over\sigma_y^2}ab+{2Q_x\over\sigma_y^2}b^2\cr
                    &={2\over\sigma_y^2}(na^2+2S_xab+Q_xb^2)\cr
  }
$$
Agora, sejam $x=(x_1,\ldots,x_n)$ e $u=(1,\ldots,1)$, pela desigualdade de {\bsl Cauchy-Bunyakovski-Schwartz} inferimos
$$
  S_x=\langle x,u\rangle\leq\sqrt{\sum_ix_i^2}\sqrt{n}=\sqrt{Q_x}\sqrt{n},
$$
donde conclu\'\i mos que
$$
  \Delta=S_x^2-nQ_x\leq0,
$$
com $\Delta$ sendo o discriminate de 
$$
  na^2+2S_xab+Q_xb^2.
$$
O m\'etodo dos m\'\i nimos quadrados s\'o \'e significativo se n\~ao for o caso que todos os $x_i$ s\~ao iguais. Sob est\'a hip\'otese, segue-se que $\Delta<0$ consequentemente

$$
  H(A,B)\cdot(a,b)>0,
$$
para todo $(a,b)\neq(0,0)$. Portanto, o ponto cr\'\i tico $(A,B)$ \'e ponto de m\'\i nimo local de $\chi^2$.
...
$$
usando as duas primeiras casas decimas obtemos que $\delta_g=0.19$. Por fim,
$$
